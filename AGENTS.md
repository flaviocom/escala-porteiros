...
> **3.** [`handoff mais recente`](docs/handoff/HANDOFF_2026-08-05-f.md) (o que aconteceu e por quê) →
...
```bash
npm run gate      # 26 passos: typecheck · testes (2 fusos) · denominação · fontes · contagem · cadeia · genérico + autoteste · catálogo gerado · comandos citados · arquitetura · auditoria · regras mestras · build
```
...
| O que aconteceu na última sessão, e por quê | [`docs/handoff/HANDOFF_2026-08-05-f.md`](docs/handoff/HANDOFF_2026-08-05-f.md) · [índice](docs/handoff/INDICE.md) |
