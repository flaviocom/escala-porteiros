...
> 3. Leia o **[handoff mais recente](docs/handoff/HANDOFF_2026-08-19-b.md)** (o que aconteceu e por quê).
...
> **3.** [`handoff mais recente`](docs/handoff/HANDOFF_2026-08-19-b.md) (o que aconteceu e por quê) →
...
Os 63 scripts de `scripts/` (portões, validações ao vivo, ferramentas de dados) estão catalogados
...
| O que aconteceu na última sessão, e por quê | [`docs/handoff/HANDOFF_2026-08-19-b.md`](docs/handoff/HANDOFF_2026-08-19-b.md) · [índice](docs/handoff/INDICE.md) |
