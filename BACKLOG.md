...
| P7.7 | 🟠 **`fronteira` recriada a cada render** no `Admin`, derrubando a memoização de `validar` e `conferirPorFora` nas abas Ajustar e Conferir | `src/admin/Admin.tsx` | ✅ **FECHADO 05/08** — dentro de `useMemo` |
