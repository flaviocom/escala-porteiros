# Fatia do histórico — DIÁRIO DE BORDO, 04/08/2026 (DB-001 a DB-012)

> **Imutável.** Fatiado do `DIARIO_DE_BORDO.md` em 07/08/2026, quando o documento vivo passou de
> 2.000 linhas. Regime histórico: fatia por PERÍODO, nada se apaga.
> **Voltar:** [`índice do histórico`](INDICE.md) · [`DIARIO_DE_BORDO.md`](../../DIARIO_DE_BORDO.md)
