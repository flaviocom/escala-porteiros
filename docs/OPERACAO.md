...
| 17 | `selo:autoteste` | 🔒 prova que o selo (37) **morde** — 7 casos: acusa mutação real, acusa arquivo novo, acusa sumiço, acusa renomeação (achado da auditoria, 19/08/2026), recusa sem selo gravado, e (o achado de 19/08/2026 na retomada) **não acusa** quando o mesmo conteúdo só troca de staged/unstaged entre gravar e conferir |
...
| 37 | `selo:gravar` | 🔒 guarda a impressão digital da árvore. `npm run selo:conferir`, antes de commitar, prova que o verde acima é **desta** árvore. 🔴 **19/08/2026:** a impressão digital misturava blob-do-índice (LF-normalizado) com bytes-do-disco (CRLF) para o mesmo tipo de arquivo em momentos diferentes — corrigido para ler sempre o disco, nunca o índice do git. 🟡 **mesmo dia, achado pela auditoria cega do conserto:** renomear um arquivo staged virava um candidato fantasma no cálculo — corrigido para usar o caminho real; o selo continua (corretamente) acusando renomeação, pois o caminho mudou de verdade |
